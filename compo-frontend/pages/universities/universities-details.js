...
import { CustomTab } from '../../components/core/CustomForms';
import { CustomBorderLinearProgress } from '../../components/core/CustomForms';
...
export default function UniversitiesDetails() {
    ...
    console.log("uniiiii", universities);
    ...
    const items = [Gallery1, Gallery2, Gallery3].map((img) => {
        ...
        return (
            <div className='flex items-center cursor-pointer text-white carousel-image'>
                <Image
                    src={img}
                    alt={img}
                    key={img}
            ...
            <div className="bg-colorPale pb-20 md:pb-28">
                ...
                <div className="bg-[#F9F9FA]">
                    <div className='flex items-center justify-center -mt-12 lg:-mt-16	relative '>
                        <div className=' rounded-xl bg-white  w-full  md:w-11/12 lg:w-10/12	 xl:w-2/3'>
                                    ...
                                    <div className='grid grid-cols-1'>
                                        <div className='grid grid-cols-6 gap-4 items-center'>
                                            <div className='col-span-3 lg:col-span-2'>
                                                <div className='font-semibold text-2xl lg:text-3xl text-[#000000]'>
                                                    University of Dubai.
                                                </div>
                                            </div>
                                            <div className='col-span-3 lg:col-span-4'>
                                                ...
                                                <button
                                                    className="bg-[#1E75FF] hover:bg-[#1E75FF] text-[#FAFAFB] px-5 py-1.5 items-center text-xs rounded-xl font-semibold hover:scale-95 transition-all duration-300 ">
                                                    Apply Now
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div className='grid grid-cols-1 mt-4'>
                                        <div className='grid grid-cols-6 gap-4 '>
                                            ...
                                            <div className='lg:col-span-4 col-span-3 '>
                                                ...
                                                <div className="grid grid-cols-1 lg:grid-cols-2 text-[#92929D] text-sm	font-normal	">
                                                ...
                                                <div className="grid grid-cols-1 lg:grid-cols-2  text-[#92929D] text-sm mt-0 lg:mt-2 font-normal	">
                                                    <div className="grid grid-cols-2 items-center">
                                                        <p >
                                                            University Type
                                                        </p>
                    ...
                    <div className="w-full  md:w-11/12 lg:w-10/12 xl:w-2/3 mx-auto">
                            ...
                            <div className='col-span-1 mt-6'>
                                ...
                                <Box className="rounded-lg bg-white mt-4">
                                    ...
                                    <div className="p-4">
                                        ...
                                        <button type="button" className="mt-6 inline-block w-full px-6 py-2 border capitalize border-[#0364FF] text-[#0364FF] font-semibold text-sm rounded-xl hover:scale-95 transition-all duration-300">
                                            Apply Now
                                        </button>
                                    </div>
                                </Box>
                            ...
                            <div className="col-span-2 mt-6" >
                                ...
                                <TabPanel value={value} index={1}>
                                    ...
                                    <div className='p-6 bg-[#FFFFFF] rounded-lg mt-8'>
                                        ...
                                        <div className="grid grid-cols-1  lg:grid-cols-3  gap-6 mt-10 pb-12 border-b border-[colorGrey] ml-4">
                                            <div className='gap-6'>
                                        ...
                                        <div className='mt-12'>
                                            ...
                                            <div className="grid grid-cols-3 gap-4 mt-8 items-center">
                                                ...
                                                <div className="self-center">
                                                    <CustomBorderLinearProgress variant="determinate" value={80} setColor="#2AA18A" />
                                                </div>
                    ...
                    <div className="w-full  md:w-11/12 lg:w-10/12 xl:w-2/3 mx-auto flex mt-24 justify-between">
                    ...
                    <div className="w-full  md:w-11/12 lg:w-10/12 xl:w-2/3 mx-auto mt-24">
