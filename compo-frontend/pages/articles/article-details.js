    ...
    <>
      ...
      <div className="bg-colorPale pb-20 md:pb-28">
        ...
        <div className="container py-10">
          ...
          <p className="mt-9 w-[175px] flex flex-wrap text-[#000000] font-normal text-xl font-['PT_Serif']">
            Lorem ipsum, everyone 👏
          </p>
          <p className="mt-6 flex flex-wrap text-[#000000] font-normal text-xl font-['PT_Serif']">
          ...
          <div className="mt-6 font-normal text-xl text-[#000000] font-['PT_Serif']">
          ...
          <p className="mt-3 text-xl text-[#000000] font-normal font-['PT_Serif']">
            Lacinia ut gravida tempus sollicitudin condimentum sit urna cursus
            malesuada. Eu lacus dis et tempor non. Odio tristique dignissim
            lorem ipsum vestibulum. Cras quisque praesent.
          </p>
          ...
          <p className="mt-1 text-xl text-[#000000] font-normal font-['PT_Serif']">
            Lacinia ut gravida tempus sollicitudin condimentum sit urna cursus
          ...
          <p className="mt-2 text-xl text-[#000000] font-normal font-['PT_Serif']">
            Lacinia ut gravida tempus sollicitudin condimentum sit urna cursus
            malesuada. Eu lacus dis et tempor non. Odio tristique dignissim
            lorem ipsum vestibulum. Cras quisque praesent.
          </p>
