  ...
  return (
    <div className="py-10">
      <div className="grid grid-cols-12 gap-2">
        <div className="col-span-12 sm:col-span-8 py-2">
          <div className="flex">
            <div className="bg-[#EBF2FE] rounded-md text-[#232E52] font-black text-sm leading-[120%] text-center uppercase px-3 py-2">
              Design tools
            </div>
            <div className="bg-colorWhite rounded-md text-[#232E52] font-medium text-sm leading-[120%] text-center uppercase px-3 py-2">
              AUGust 13, 2021
            </div>
          </div>
          <div className="design-tool-cover flex sm:hidden mt-4">
        ...
        <div className="col-span-4 design-tool-cover hidden sm:flex">
          <Image src={DesignToolImage} />
        </div>
      </div>
    </div>
