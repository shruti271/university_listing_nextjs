  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 h-full">
      <div className="p-4 hidden sm:block h-full">
        {activeStep === 0 && (
          <div className="!bg-cover w-full h-full onboarding1-cover text-center">
            <Image src={LoginLogo} alt="CoverImage" />
          </div>
        )}
        {activeStep === 1 && (
          <div className="!bg-cover w-full h-full  onboarding2-cover text-center">
            <Image src={LoginLogo} alt="CoverImage" />
          </div>
        )}
        {activeStep === 2 && (
          <div className="!bg-cover w-full h-full  onboarding3-cover text-center">
            <Image src={LoginLogo} alt="CoverImage" />
          </div>
        )}
      </div>
