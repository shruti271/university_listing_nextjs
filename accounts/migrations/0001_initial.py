    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('validated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.user')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desired_job', models.CharField(blank=True, max_length=200)),
                ('desired_degree', models.CharField(blank=True, max_length=200)),
